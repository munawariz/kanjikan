...
const TONES = {
  ...
  sage: { background: "var(--surface-chip)", color: "var(--on-tint-heading)", border: "1px solid var(--surface-chip)" },
  white: { background: "var(--surface-card)", color: "var(--text-heading)", border: "1px solid var(--border-subtle)" },
